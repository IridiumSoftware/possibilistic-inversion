...
\item The forced/measure-dependent split is \textbf{conditional on the
  ...
  preference shift the decomposition quantifiably (\S6 item 7,
...
The Tier-1 sensitivity finding (\S6 item 7, Figure~\ref{fig:sensitivity})
...
coverage-certificate discipline (\S6 item 6), modular decomposition library
